...
export default function CoinList({ coin, index, fetchCoin, page, perPage }) {
  return (
    <div className="grid grid-cols-10 gap-y-3 border-b-2 border-[#1D2025] items-center px-2 py-[5px] text-xs font-semibold">
      <div className="col-span-1">{index + (page - 1) * perPage + 1}</div>
      ...
      <div className="after:content-['$'] after:ml-1 col-span-2">
